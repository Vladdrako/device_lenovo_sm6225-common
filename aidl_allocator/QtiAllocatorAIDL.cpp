...
#define USE_SYSTEM_HEAP_FOR_SENSORS_PROP "vendor.display.use_system_heap_for_sensors"
#define DISABLE_AHARDWARE_BUFFER_PROP "vendor.display.disable_ahardware_buffer"
#define ENABLE_LOGS_PROP "vendor.display.enable_logs"
